...
| Domain benchmark | Partial | Versioned local artifact measures 500 geofence alerts at p95 25.95 ms, 500/500 notification retries in 351.04 ms, 1,000 trips into 250/250 rollups in 4.53 ms, report-render p95 35.70 ms, raw samples, cleanup, and CI budgets | Capture fresh CI artifact; add production-shaped backlogs and real-provider acceptance |
